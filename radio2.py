...
st.markdown("<h1 style='text-align: center;'><b>NON PO PAYMENT ANALYSIS </b></h1>",
...
if st.session_state.upload:
    ...
    #
    #             st.write(
    #                 "<h2 style='text-align: center; font-size: 25px; font-weight: bold;'>Amount Spent -Category</h2>",
    #                 unsafe_allow_html=True)
    #
    ...
    #             )
    #             st.write(
    #                 "<h2 style='text-align: center; font-size: 25px; font-weight: bold;'>Transaction Count-Category</h2>",
    #                 unsafe_allow_html=True)
    #             st.write("")
    ...
    #         # st.markdown(download_link, unsafe_allow_html=True)
    # display_dashboard(data1)
    #
    # @st.experimental_fragment
    # def display_yearlydashboard(data):
    #     with t1:
                            ...
                            st.dataframe(
                                filtered_df1[
                                    ['Payable req.no', 'Doc.Type', 'ReimbursementID', 'Amount', 'Document Date',
                                     'Name',
                                     'Invoice Number', 'Text', 'Cost Center', 'G/L', 'Document No',
                                     'Posting Date', 'Creator ID', 'Verifier ID', 'HOG/HOD(Approval) ID']].style.set_properties(**{'font-size': '16px'})
                            )
