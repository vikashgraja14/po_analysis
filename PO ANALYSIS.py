...
if st.session_state.upload:
    ...
    #
    # def Special_exceptions(inv_specialdf):
    #
    #     with t3:
    #         filtered_df = inv_specialdf
    #         filtered_df.rename(
    #             columns={
    #                 "Vendor": "Reimbursement ID",
    #                 'Pstng Date': "Posting Date"
    ...
    #         # filtered_df = filtered_df.drop_duplicates(subset=['Reimbursement ID', 'Invoice Number'], keep='last')
    ...
    #                 st.markdown(download_link, unsafe_allow_html=True)
    # Special_exceptions(inv_specialdf)
    with t5:
    ...
    with t52:
        ...
        excel_b64 = base64.b64encode(excel_buffer.getvalue()).decode()
        # Download link for Excel file within a Markdown
        download_link = f'<a href="data:file/xls;base64,{excel_b64}" download="Exceptions.xlsx">Download Excel file</a>'
        st.markdown(download_link, unsafe_allow_html=True)
    with t6:
