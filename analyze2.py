...
def display_duplicate_invoices(exceptions):
    ...
    st.write(
        "<h2 style='text-align: center; font-size: 35px; font-weight: bold;'>Entries with Duplicate Invoices</h2>",
        unsafe_allow_html=True)
    st.write("")
    if dfe.empty:
        st.write(
            "<div style='text-align: center; font-weight: bold;'>No entries with same Invoice Number</div>",
            unsafe_allow_html=True)
    else:
...
def same_Creator_Verified_HOG(exceptions):
    ...
    dfe.index += 1  # Start index from 1
    st.write(
        "<h2 style='text-align: center; font-size: 35px; font-weight: bold;'>Entries with same Creator ID , Verified ID and HOG Approval</h2>",
        unsafe_allow_html=True)
    st.write("")
    if dfe.empty:
        st.write(
            "<div style='text-align: center; font-weight: bold;'>No entries with same Creator ID, Verified ID and HOG Approval ID</div>",
            unsafe_allow_html=True)
    else:
...
def same_Creator_Verified_HOGno(exceptions):
    ...
    dfe.index += 1  # Start index from 1
    st.write(
        "<h2 style='text-align: center; font-size: 35px; font-weight: bold;'>Entries with same Creator ID , Verified ID  and HOG Approval Is None</h2>",
        unsafe_allow_html=True)
    st.write("")
    if dfe.empty:
        st.write(
            "<div style='text-align: center; font-weight: bold;'>No entries with same Creator ID, Verified ID and With No HOG Approval</div>",
            unsafe_allow_html=True)
    else:
        c111, card1, middle_column, card2, c222 = st.columns([1, 4, 1, 4, 1])
        with card1:
...
def Creator_Verified_HOGno(exceptions):
    ...
    dfe.index += 1  # Start index from 1
    st.write(
        "<h2 style='text-align: center; font-size: 35px; font-weight: bold;'>Entries With No HOG Approval</h2>",
        unsafe_allow_html=True)
    st.write("")
    if dfe.empty:
        st.write(
            "<div style='text-align: center; font-weight: bold;'>No entries Without HOG Approval</div>",
            unsafe_allow_html=True)
    else:
        c111, card1, middle_column, card2, c222 = st.columns([1, 4, 1, 4, 1])
        with card1:
...
def Creator_HOG(exceptions):
    ...
    dfe.index += 1  # Start index from 1
    st.write(
        "<h2 style='text-align: center; font-size: 35px; font-weight: bold;'>Entries With Same CreatorID and HOG ApprovalID</h2>",
        unsafe_allow_html=True)
    st.write("")
    if dfe.empty:
        st.write(
            "<div style='text-align: center; font-weight: bold;'>No entries With Same CreatorID and HOG ApprovalID</div>",
            unsafe_allow_html=True)
    else:
        c111, card1, middle_column, card2, c222 = st.columns([1, 4, 1, 4, 1])
        with card1:
...
def same_Creator_Verified(exceptions):
    ...
    dfe.index += 1  # Start index from 1
    st.write(
        "<h2 style='text-align: center; font-size: 35px; font-weight: bold;'>Entries With Same Creator ID And Verified ID</h2>",
        unsafe_allow_html=True)
    st.write("")
    if dfe.empty:
        st.write(
            "<div style='text-align: center; font-weight: bold;'>No entries with same Creator ID And Verified ID </div>",
            unsafe_allow_html=True)
    else:
        c111, card1, middle_column, card2, c222 = st.columns([1, 4, 1, 4, 1])
        with card1:
...
def Approval_holidays(exceptions):
    ...
    st.write(
        "<h2 style='text-align: center; font-size: 35px; font-weight: bold;'>ENTRIES MADE ON HOLIDAYS</h2>",
        unsafe_allow_html=True)
    st.write("")
    if dfe.empty:
        st.write(
            "<div style='text-align: center; font-weight: bold;'>No entries made on holidays</div>",
            unsafe_allow_html=True)
    else:
