...
if st.session_state.upload:
    ...
    # t1,t4 = st.tabs(["Exceptions","Radio Button"])
    with t2:
    ...
    with ((((t4)))):
        ...
        with t41:
            ...
            def is_similarity_high(string1, string2, similarity_threshold=0.8):
                string1 = str(string1)
                string2 = str(string2)
                calculated_similarity = difflib.SequenceMatcher(None, string1, string2).ratio()
                return calculated_similarity >= similarity_threshold
