...
if st.session_state.upload:
    ...
    with t2:
        ...
        vendor_name_dict = dict(zip(filtered_data['Vendor'], filtered_data['Vendor Name'].astype(str)))
        # Map 'Vendor Name' to 'Creator' where applicable
        filtered_data['Created'] = filtered_data['Created'].apply(
            lambda x: x + '-' + vendor_name_dict.get(x, '') if x in vendor_name_dict else x)
        filtered_data['Cost Ctr'] = filtered_data['Cost Ctr'] + ' - ' + filtered_data[
            'CostctrName']
        # Create a dictionary of vendors and their names
        ...
        filtered_data['Cost Ctr'] = filtered_data['Cost Ctr'].astype(str)
        filtered_data['G/L'] = filtered_data['G/L'].astype(str)
        filtered_data['Created'] = filtered_data['G/L'].astype(str)
        filtered_data['Vendor'] = filtered_data['Vendor'].astype(str)
